        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('admin.index')}}">
                    ...
                    <div class="sidebar-brand-text mx-3">  Confort Solares - Vendedor<sup>2</sup></div>
                </a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="{{route('admin.registrarcliente')}}"> Clientes</a> 
                ...
                <li class="nav-item">
                    ...
                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="{{route('admin.indexproducto')}}">Opciones de Productos</a>
                            <a class="collapse-item" href="register.html">Registrar productos</a>
...
<div class="block mx-auto my-14 p-8 bg-white w-1/1 borderr border-gray-200 rounded-lg shadow-lg">
<h1 class="text-3xl text-left font-bold">UTILIDADES</h1>

<h1 class="my-5"></h1>

<from class="mt-4">
<li class="mx-6">
  <a href="{{route('admin.registrarcliente')}}" class="font-semibold border-2 border-green-700 py-2 px-4 rounded-md hover:bg-green-700 hover:text-white">Clientes</a>
</li>

<li class="my-6 mx-6">
  <a href="{{route('admin.registrarusuario')}}" class="font-semibold border-2 border-green-700 py-2 px-4 rounded-md hover:bg-green-700 hover:text-white">Usuarios</a>
</li>
